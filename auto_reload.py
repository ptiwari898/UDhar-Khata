...
FLUTTER_APP_DIR = os.path.join(ROOT_DIR, "flutter_app")
LIB_DIR = os.path.join(FLUTTER_APP_DIR, "lib")
...
def main():
    ...
    proc = subprocess.Popen(
        cmd,
        cwd=FLUTTER_APP_DIR if os.path.exists(FLUTTER_APP_DIR) else ROOT_DIR,
